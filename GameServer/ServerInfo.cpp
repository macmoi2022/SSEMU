...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gCustomRespawn->Load(gPath->GetFullPath("Custom\\CustomRespawn.txt"));

	gCustomMove->Load(gPath->GetFullPath("Custom\\CustomMove.txt"));

	gCustomGate->Load(gPath->GetFullPath("Custom\\CustomGate.txt"));
	...
	gItemAttribute->Load(gPath->GetFullPath("Custom\\CustomAttribute.txt"));

	gCustomPet->Load(gPath->GetFullPath("Custom\\CustomPet.txt"));

	gSummonScroll->Load(gPath->GetFullPath("Custom\\SummonScroll.txt"));

	DuelEvent.Load(gPath->GetFullPath("Custom\\Event\\DuelEvent.txt"));

	DeathEvent.Load(gPath->GetFullPath("Custom\\Event\\DeathEvent.txt"));

	RoletaEvent.Load(gPath->GetFullPath("Custom\\Event\\RoletaEvent.txt"));

	RaffleEvent.Load(gPath->GetFullPath("Custom\\Event\\RaffleEvent.txt"));

	PairEvent.Load(gPath->GetFullPath("Custom\\Event\\PairEvent.txt"));

	SobreEvent.Load(gPath->GetFullPath("Custom\\Event\\SobreEvent.txt"));

	TheftEvent.Load(gPath->GetFullPath("Custom\\Event\\TheftEvent.txt"));

	gCustomGuard->Load(gPath->GetFullPath("Custom\\CustomGuard.txt"));

	gCustomMobCombo->Load(gPath->GetFullPath("Custom\\CustomMobCombo.txt"));

	gLuckyWheel->Load(gPath->GetFullPath("Custom\\CustomLuckyWheel.txt"));

	gLuckyWheel->ReloadLuckyWheelInterface();

	DailyReward->Read(gPath->GetFullPath("Custom\\DailyReward.txt"));

	Patent.Load(gPath->GetFullPath("Custom\\CustomPatente.txt"));

	gCustomEvo->Load(gPath->GetFullPath("Custom\\CustomEvolution.txt"));
}
...
void CServerInfo::ReadEventInfo() // OK
{
	...
	gCustomQuiz->ReadCustomQuizInfo("GameServerInfo", ".\\Data\\GameServerInfo - Event.dat");
...
void CServerInfo::ReadLangInfo() // OK
{
	this->ReadLangInfo("GameServerInfo",".\\Data\\GameServerInfo - Common.dat");

	gMessage->Load(gPath->GetFullPath("Lang\\Eng\\Message.txt"),0);

	gMessage->Load(gPath->GetFullPath("Lang\\Por\\Message.txt"),1);

	gMessage->Load(gPath->GetFullPath("Lang\\Spn\\Message.txt"),2);

	gNotice->Load(gPath->GetFullPath("Lang\\Eng\\Notice.txt"),0);

	gNotice->Load(gPath->GetFullPath("Lang\\Por\\Notice.txt"),1);

	gNotice->Load(gPath->GetFullPath("Lang\\Spn\\Notice.txt"),2);
}
...
{
	gItemManager->GetItemBmd(gPath->GetFullPath("Item\\Item_Eng.bmd"));
	gItemManager->GetItemBmd(gPath->GetFullPath("Item\\Item_Por.bmd"));
	gItemManager->GetItemBmd(gPath->GetFullPath("Item\\Item_Spn.bmd"));
}
...
void CServerInfo::ReadStartupInfo(char* section,char* path) // OK
{
	...
	this->m_ServerMaxUserNumber = GetPrivateProfileInt(section, "limiteuser", 50, path);
...
void CServerInfo::ReadChaosMixInfo(char* section,char* path) // OK
{
	...
	this->FailMixMode[0] = GetPrivateProfileInt(section, "FailMixMode_AL0", 0, path);
	this->FailMixMode[1] = GetPrivateProfileInt(section, "FailMixMode_AL1", 0, path);
	this->FailMixMode[2] = GetPrivateProfileInt(section, "FailMixMode_AL2", 0, path);
	this->FailMixMode[3] = GetPrivateProfileInt(section, "FailMixMode_AL3", 0, path);
}
...
void CServerInfo::ReadCommandInfo(char* section,char* path) // OK
{
	...
	this->m_CommandMasterResetPointType = GetPrivateProfileInt(section, "CommandMasterResetPointType", 0, path);
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_AnnounceMinLevelChaosMix = GetPrivateProfileInt(section, "AnnounceMinLevelChaosMix", 13, path);

	this->m_MaxItemLevel = GetPrivateProfileInt(section, "MaxItemLevel", 0, path);
	...
	this->m_HelperExperienceRate[0] = GetPrivateProfileInt(section,"HelperExperienceRate_AL0",0,path);
	this->m_HelperExperienceRate[1] = GetPrivateProfileInt(section,"HelperExperienceRate_AL1",0,path);
	this->m_HelperExperienceRate[2] = GetPrivateProfileInt(section,"HelperExperienceRate_AL2",0,path);
	this->m_HelperExperienceRate[3] = GetPrivateProfileInt(section,"HelperExperienceRate_AL3",0,path);
	...
	this->m_HelperOfflineExperienceRate[0] = GetPrivateProfileInt(section,"HelperOfflineExperienceRate_AL0",0,path);
	this->m_HelperOfflineExperienceRate[1] = GetPrivateProfileInt(section,"HelperOfflineExperienceRate_AL1",0,path);
	this->m_HelperOfflineExperienceRate[2] = GetPrivateProfileInt(section,"HelperOfflineExperienceRate_AL2",0,path);
	this->m_HelperOfflineExperienceRate[3] = GetPrivateProfileInt(section,"HelperOfflineExperienceRate_AL3",0,path);

	this->m_HelperOfflineKeepEnable[0] = GetPrivateProfileInt(section,"HelperOfflineKeepEnable_AL0",0,path);
	this->m_HelperOfflineKeepEnable[1] = GetPrivateProfileInt(section,"HelperOfflineKeepEnable_AL1",0,path);
	this->m_HelperOfflineKeepEnable[2] = GetPrivateProfileInt(section,"HelperOfflineKeepEnable_AL2",0,path);
	this->m_HelperOfflineKeepEnable[3] = GetPrivateProfileInt(section,"HelperOfflineKeepEnable_AL3",0,path);
...
void CServerInfo::ReadEventInfo(char* section,char* path) // OK
{
	...
	this->m_BloodCastleDuelEnable = GetPrivateProfileInt(section, "BloodCastleDuelEnable", 0, path);
	...
	this->m_CastleSiegeRegisterMinMasterLevel = GetPrivateProfileInt(section,"CastleSiegeRegisterMinMasterLevel",0,path);
	this->m_CastleSiegeRegisterMinGuildMember = GetPrivateProfileInt(section,"CastleSiegeRegisterMinGuildMember",0,path);
	...
	this->m_DevilSquareDuelEnable = GetPrivateProfileInt(section, "DevilSquareDuelEnable", 0, path);
...
void CServerInfo::ReadItemInfo(char* section,char* path) // OK
{
	...
	this->m_IndulgenceTimeConstA = GetPrivateProfileInt(section,"IndulgenceTimeConstA",0,path);
	...
	this->m_SealEffectTime = GetPrivateProfileInt(section, "SealEffectTime", 0, path);
}

void CServerInfo::ReadLangInfo(char* section,char* path) // OK
{
...
void CServerInfo::ReadSkillInfo(char* section,char* path) // OK
{
	...
	this->m_TwoWeaponsDamageEnable = GetPrivateProfileInt(section, "TwoWeaponsDamageEnable", 100, path);
	this->m_TwoWeaponsDamageMinConstA[CLASS_DW] = GetPrivateProfileInt(section, "DWTwoWeaponsDamageMinConstA", 100, path);
	this->m_TwoWeaponsDamageMinConstA[CLASS_DK] = GetPrivateProfileInt(section, "DKTwoWeaponsDamageMinConstA", 100, path);
	this->m_TwoWeaponsDamageMinConstA[CLASS_FE] = GetPrivateProfileInt(section, "FETwoWeaponsDamageMinConstA", 100, path);
	this->m_TwoWeaponsDamageMinConstA[CLASS_MG] = GetPrivateProfileInt(section, "MGTwoWeaponsDamageMinConstA", 100, path);
	this->m_TwoWeaponsDamageMinConstA[CLASS_DL] = GetPrivateProfileInt(section, "DLTwoWeaponsDamageMinConstA", 100, path);

	this->m_TwoWeaponsDamageMaxConstA[CLASS_DW] = GetPrivateProfileInt(section, "DWTwoWeaponsDamageMaxConstA", 100, path);
	this->m_TwoWeaponsDamageMaxConstA[CLASS_DK] = GetPrivateProfileInt(section, "DKTwoWeaponsDamageMaxConstA", 100, path);
	this->m_TwoWeaponsDamageMaxConstA[CLASS_FE] = GetPrivateProfileInt(section, "FETwoWeaponsDamageMaxConstA", 100, path);
	this->m_TwoWeaponsDamageMaxConstA[CLASS_MG] = GetPrivateProfileInt(section, "MGTwoWeaponsDamageMaxConstA", 100, path);
	this->m_TwoWeaponsDamageMaxConstA[CLASS_DL] = GetPrivateProfileInt(section, "DLTwoWeaponsDamageMaxConstA", 100, path);
...
{
	this->m_eZenCusto = GetPrivateProfileInt(section, "eZentaxa", 0, path);
	this->m_eZenReward = GetPrivateProfileInt(section, "eZenReward", 0, path);

	this->m_killLevel1 = GetPrivateProfileInt(section, "EnableKillLevel1", 0, path);

	this->m_InfinityPotionRate[0] = GetPrivateProfileInt(section, "InfinityPotion_AL0", 0, path);
	this->m_InfinityPotionRate[1] = GetPrivateProfileInt(section, "InfinityPotion_AL1", 0, path);
	this->m_InfinityPotionRate[2] = GetPrivateProfileInt(section, "InfinityPotion_AL2", 0, path);
	this->m_InfinityPotionRate[3] = GetPrivateProfileInt(section, "InfinityPotion_AL3", 0, path);

#if(GAMESERVER_UPDATE >= 201)
	this->RestoreSD = GetPrivateProfileInt(section, "RestoreSDLogin", 0, path);
#endif

	this->SellItemExc = GetPrivateProfileInt(section, "BlockSellItemExc", 0, path);

	this->AccountLevelBox[0] = GetPrivateProfileInt(section, "PackageType_AL0", 0, path);
	this->AccountLevelBox[1] = GetPrivateProfileInt(section, "PackageType_AL1", 0, path);
	this->AccountLevelBox[2] = GetPrivateProfileInt(section, "PackageType_AL2", 0, path);

	this->DaysBox[0] = GetPrivateProfileInt(section, "PackageDays_AL0", 0, path);
	this->DaysBox[1] = GetPrivateProfileInt(section, "PackageDays_AL1", 0, path);
	this->DaysBox[2] = GetPrivateProfileInt(section, "PackageDays_AL2", 0, path);

	this->LuckyWheelMoney = GetPrivateProfileInt(section, "LuckyWheelCustValue", 0, path);
}