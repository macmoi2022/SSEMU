...
struct PMSG_NEW_ADVANCED_CALC_SEND
{
	PSBMSG_HEAD header; // C1:F3:E1

#if(GAMESERVER_UPDATE == 101)
	DWORD ViewTotalDamageReflect;
	DWORD ViewCriticalDamageRate;
	DWORD ViewCriticalDamagePVM;
	DWORD ViewCriticalDamagePVP;
	DWORD ViewExellentDamageRate;
	DWORD ViewExellentDamagePVM;
	DWORD ViewExellentDamagePVP;
	DWORD ViewDoubleDamageRate;
	DWORD ViewTripleDamageRate;
	DWORD ViewIgnoreDefenceRate;
	DWORD ViewIncreaseDamagePvP;
	DWORD ViewIncreaseDefencePvP;
	DWORD ViewMoneyRate;
	DWORD ViewDamageReductionRate;
#endif
	...
	DWORD ViewDoubleDamageRate;
	DWORD ViewTripleDamageRate;
	DWORD ViewShieldSkillDamageReductionRate;
	DWORD ViewSDDamageReductionRate;
	DWORD ViewSDDecreaseDamageRate;
	DWORD ViewIgnoreDefenceRate;
	DWORD ViewIgnoreSDRate;
	DWORD ViewIncreaseDamagePvP;
	DWORD ViewIncreaseDefencePvP;
	DWORD ViewMoneyRate;
	DWORD ViewDamageReductionRate;
...
void GCNewMessageSend(int aIndex,int type,int color,int message,...);
...
void GCNewAdvancedCalcSend(LPOBJ lpObj);