...
public:
	...
	bool CharacterUseJewelOfEvolution(LPOBJ lpObj, int SourceSlot, int TargetSlot);
	bool CharacterUseJewelOfSetEvolution(LPOBJ lpObj, int SourceSlot, int TargetSlot);
};
