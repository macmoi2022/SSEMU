...
class CImperialGuardian
{
	...
	SingletonInstance(CImperialGuardian)
public:
	void Load(char* path);
	void MainProc();
	...
	void DropStoneStatueItem(LPOBJ lpObj,LPOBJ lpTarget);
	...
	void NoticeSendToAll(int type,int message,...);
...
#define gImperialGuardian SingNull(CImperialGuardian)
