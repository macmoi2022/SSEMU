...
void PostMessage_1(char* name, char* message, char* text) // OK
{
...
void PostMessage_2(char* name, char* message, char* text) // OK
{
#if(GAMESERVER_UPDATE>=701)
...
void PostMessage_3(char* name, char* message, char* text) // OK
{
#if(GAMESERVER_UPDATE>=701)
...
void PostMessage_4(char* name, char* message, char* text) // OK
{
#if(GAMESERVER_UPDATE>=701)
...
void PostMessage1(char* name,int index,char* message) // OK
{
	#if(GAMESERVER_UPDATE>=701)
	...
	for(int n=OBJECT_START_USER;n < MAX_OBJECT;n++)
	{
		...
		wsprintf(buff,gMessage->GetText(index,gObj[n].Lang),name,message);
	...
	for(int n=OBJECT_START_USER;n < MAX_OBJECT;n++)
	{
		if(gObjIsConnectedGP(n) != 0)
		{
			...
			wsprintf(buff,gMessage->GetText(index,gObj[n].Lang),message);
...
void PostMessage2(char* name,int index,char* message) // OK
{
	#if(GAMESERVER_UPDATE>=701)
	...
	for(int n=OBJECT_START_USER;n < MAX_OBJECT;n++)
	{
		...
		wsprintf(&buff[1],gMessage->GetText(index,gObj[n].Lang),message);
...
void PostMessage3(char* name,int index,char* message) // OK
{
	#if(GAMESERVER_UPDATE>=701)
...
void PostMessage4(char* name,int index,char* message) // OK
{
	#if(GAMESERVER_UPDATE>=701)
