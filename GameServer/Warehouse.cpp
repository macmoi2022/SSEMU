...
void CWarehouse::GCWarehouseStateSend(int aIndex, BYTE state) // OK
{
	...
	pMsg.Amount = gServerInfo->m_CommandWareNumber[lpObj->AccountLevel];
...
bool CWarehouse::WarehouseChangeRecv(PMSG_WAREHOUSE_CHANGE_RECV* lpMsg, int aIndex) // Change Ware
{
	LPOBJ lpObj = &gObj[aIndex];
