...
struct SDHP_UPDATE_PATENTE_SEND
{
...
void GDRankingUpdateSend(int aIndex, char* Coluna, DWORD Score);
void GDAtualizarPatenteSend(int aIndex, int patente);
void GDSetCoinSend(int aIndex, int Gold, char* LogName);