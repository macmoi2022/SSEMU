...
enum eCommandNumber
{
	...
	COMMAND_OPENWARE = 22,
	COMMAND_CHANGECLASS = 23,
	COMMAND_EZEN = 24,
	COMMAND_AUTOHP = 25,
	COMMAND_LOCK = 26,
	COMMAND_UNLOCK = 27,
	COMMAND_CUSTOM_QUIZ = 28, 
	...
	COMMAND_EVENTESC = 130,
	SOBRE_GAMEMASTER = 131,
	DUEL_GAMEMASTER = 132,
	PAIR_GAMEMASTER = 133,
	SETPATENTE = 134,
	ROLETA = 135,
...
public:
	...
	bool CommandChangeClass(LPOBJ lpObj, char* arg);
	void CommandEZen(LPOBJ lpObj);
	bool CommandPotion(LPOBJ lpObj);
	bool CommandLock(LPOBJ lpObj, char* arg);
	bool CommandUnLock(LPOBJ lpObj, char* arg);
	bool CommandPatente(LPOBJ lpObj, char* arg);
private:
