...
enum eItemBagSpecialValue
{
	...
	ITEM_BAG_SPECIAL_CUSTOM_MASTERRESET = 22,
	ITEM_BAG_SPECIAL_CUSTOM_RESET	= 23,

	ITEM_BAG_SPECIAL_EVENT_QUIZ		= 24,
	ITEM_BAG_SPECIAL_EVENT_DEATH	= 25,
	ITEM_BAG_SPECIAL_EVENT_DUEL		= 26,
	ITEM_BAG_SPECIAL_EVENT_ESCESC	= 27,
	ITEM_BAG_SPECIAL_EVENT_PAIR		= 28,
	ITEM_BAG_SPECIAL_EVENT_RAFFLE	= 29,
	ITEM_BAG_SPECIAL_EVENT_ROLETA	= 30,
	ITEM_BAG_SPECIAL_EVENT_SOBRE	= 31,
	ITEM_BAG_SPECIAL_EVENT_THEFT	= 32,
};
