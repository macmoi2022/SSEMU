...
void CProtect::StartAuth(eAuthServerType ServerType) // OK
{
	...
	if (this->ConnectToAuthServer(this->GetEncryptedString(gProtectString3, sizeof(gProtectString3)), 15212) == 0)
	{
...
void CProtect::StartAuthProc(eAuthServerType ServerType) // OK
{
#if(PROTECT_STATE==1)
