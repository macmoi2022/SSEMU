...
public:
	...
	int m_AnnounceMinLevelChaosMix;
	int m_MaxItemOption;
	int m_MaxItemLevel;
	...
	int m_HelperExperienceRate[MAX_ACCOUNT_LEVEL];
	int m_HelperOfflineSwitch;
	int m_HelperOfflineCoinGain[MAX_ACCOUNT_LEVEL];
	int m_HelperOfflineBuffEnable[MAX_ACCOUNT_LEVEL];
	int m_HelperOfflineExperienceRate[MAX_ACCOUNT_LEVEL];
	int m_HelperOfflineKeepEnable[MAX_ACCOUNT_LEVEL];
	...
	int m_CastleSiegeRegisterMinMasterLevel;
	int m_CastleSiegeRegisterMinGuildMember;
	...
	int m_CommandMasterResetPointType;
	...
	int m_SealEffectTime;
	CScript m_CalcCharacter;

	/* Custom Level, Restet, MasterReset, AccountLevel */
	...
	int FailMixMode[MAX_ACCOUNT_LEVEL];
	int m_DisablePushSkills;
	int m_InfinityPotionRate[MAX_ACCOUNT_LEVEL];

	int m_TwoWeaponsDamageEnable;
	int m_TwoWeaponsDamageMinConstA[MAX_CLASS];
	int m_TwoWeaponsDamageMaxConstA[MAX_CLASS];
	int m_TwoHandDamageRatePvP[MAX_CLASS];
	int m_TwoHandDamageRatePvM[MAX_CLASS];
	...
	int AccountLevelBox[MAX_ACCOUNT_LEVEL];
	int DaysBox[MAX_ACCOUNT_LEVEL];
