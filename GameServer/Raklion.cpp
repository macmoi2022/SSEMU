...
void CRaklion::SetState_NOTIFY2() // OK
{
	...
	gNotice->GCNoticeSendToAll(0,0,0,0,0,0,140,(((this->m_BossZoneCloseDelay/60)==0)?1:(this->m_BossZoneCloseDelay/60)));
...
void CRaklion::SetState_NOTIFY3() // OK
{
	...
	gNotice->GCNoticeSendToAll(0,0,0,0,0,0,141);
...
void CRaklion::SetState_NOTIFY4() // OK
{
	...
	gNotice->GCNoticeSendToAll(0,0,0,0,0,0,143,(((this->m_BossZoneOpenDelay/60)==0)?1:(this->m_BossZoneOpenDelay/60)));
...
void CRaklion::SetState_END() // OK
{
	...
	gNotice->GCNoticeSendToAll(0,0,0,0,0,0,144);
...
void CRaklion::RaklionMonsterDieProc(LPOBJ lpObj,LPOBJ lpTarget) // OK
{
	...
	if(lpObj->Class == 459)
	{
		...
		gNotice->GCNoticeSendToAll(0,0,0,0,0,0,142,lpTarget->Name);
	}
