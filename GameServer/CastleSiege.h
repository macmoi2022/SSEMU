...
enum eCastleJoinSide
{
	CS_JOIN_SIDE_NONE = 0,
	CS_JOIN_SIDE_DEFENSE = 1,
	CS_JOIN_SIDE_ATTACK_1 = 2,
	CS_JOIN_SIDE_ATTACK_2 = 3,
	CS_JOIN_SIDE_ATTACK_3 = 4,
};
...
public:
	...
	Coordinates CheckTeleportCastleLimit(int aIndex, int x, int y);
