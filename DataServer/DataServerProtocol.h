...
struct SDHP_RANKING_KILL_HERO_SAVE_RECV
{
	PBMSG_HEAD header; // C1:40
	WORD index;
	char account[11];
...
struct SDHP_UPDATE_PATENTE_RECV
{
	PSBMSG_HEAD header;  // F3:E7
	char nome[11];      // 
	int patente;        // 
};
...
void GDRankingUpdateSaveRecv(SDHP_RANKING_KILL_HERO_SAVE_RECV* lpMsg);
